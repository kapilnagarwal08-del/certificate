                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="add-certificates.php" class="btn btn-custom">
                            Add 
                            <span class="m-l-5">
                            <i class="fa fa-cog"></i>
                            </span>
                                    ...
                                    <tbody>
                                        <?php $sn=1; foreach($list as $item) { ?>
                                            <tr>
                                                ...
                                                <th class="text-muted"><?php if($item['category']==1) { echo 'Jewellery'; } ?></th>
                                                ...
                                                <td><?php echo htmlspecialchars($item['grossweight']); ?></td>
                                                <td><?php echo htmlspecialchars($item['diamondweight']); ?></td>
                                                <td><?php echo htmlspecialchars($item['shape']); ?></td>
                                                <td><?php echo htmlspecialchars($item['color']); ?></td>
                                                <td><?php echo htmlspecialchars($item['clarity']); ?></td>
                                                ...
                                                <td>
                                                    <a href="add-certificates.php?editID=<?php echo base64_encode($item['ID']); ?>">
                                                        <span class="label label-success">Edit</span>
                                                    </a>
                                                    <a href="add-certificates.php?deleteID=<?php echo base64_encode($item['ID']); ?>" onclick="return confirm('Are you sure you want to delete')">
