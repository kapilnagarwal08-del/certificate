	...
	function registeruser($data)
		{
			...
			if($query)
			{
				...
				$message="This is an automated email.Please Do Not reply to this email. Click below or paste it into your browser http://kawill.in/articence/success.php?articence_user=$email";
                ...
                $delivery=mail($to,$subject,$message,$headers);
					...
					if($delivery)
					{
						echo "<script>alert('Please check your mail to verify your registration.')</script>";
					}
			...
			{
				echo "<script>alert('Sorry Email-ID Already Registered')</script>";
			}
		}
