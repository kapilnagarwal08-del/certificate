				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="btn-group pull-right m-t-15">
							<a href="add-images.php" class="btn btn-custom">
							Add 
...
<thead>
									...
									<?php $sn=1; for($i=0;$i<count($list);$i++) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="uploads/<?php echo $list[$i]['image']; ?>" width="100px"/></td>
                                           
                                           <td>
												<a href="add-images.php?deleteID=<?php echo base64_encode($list[$i]['ID']); ?>" onclick="return confirm('Are you sure you want to delete')">
