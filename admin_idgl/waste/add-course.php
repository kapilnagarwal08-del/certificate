                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="view-course.php" class="btn btn-custom">
							View Courses 
							<span class="m-l-5">
							<i class="fa fa-cog"></i>
							</span>
										 ...
										 <fieldset class="form-group">
										  ...
										  <fieldset class="form-group">
                                            <label for="exampleInputEmail1">URL</label>
                                             <input type="url" class="form-control" name="url" value="<?php echo $list[$i]['url']; ?>">
                                         </fieldset>
										 
										 
										  <fieldset class="form-group">
                                            <label for="exampleInputEmail1">Date</label>
                                             <input type="date" class="form-control" name="date" value="<?php echo $list[$i]['date']; ?>"/>
