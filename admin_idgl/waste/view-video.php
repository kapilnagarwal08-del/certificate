                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="add-video.php" class="btn btn-custom">
							Add Video
							<span class="m-l-5">
							<i class="fa fa-cog"></i>
							</span>
                                ...
                                <table class="table table-bordered m-b-0">
									...
									<?php  $sn=1; for($i=0;$i<count($list);$i++) { ?>
                                        <tr>
                                           ...
                                           <td>
											<a href="add-video.php?editID=<?php echo base64_encode($list[$i]['ID']); ?>">
											<span class="label label-success">Edit</span>
											</a>
											
											
											<a href="add-video.php?deleteID=<?php echo base64_encode($list[$i]['ID']); ?>" onclick="return confirm('Are you sure you want to delete')">
