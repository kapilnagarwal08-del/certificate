                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="add-training.php" class="btn btn-custom">
							Add File
							<span class="m-l-5">
							<i class="fa fa-cog"></i>
							</span>
                                ...
                                <table class="table table-bordered m-b-0">
									...
									<?php  $sn=1; for($i=0;$i<count($list);$i++) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $list[$i]['heading']; ?></td>
											 <td><?php echo $list[$i]['date']; ?></td>
                                            <td><a href="uploads/<?php echo $list[$i]['image']; ?>" target="_blank" class="btn btn-custom">Download</a></td>
											
											<td><?php echo $list[$i]['status']==1?'Active':'Inactive'; ?></td>
                                            <td>
											 <a href="add-training.php?editID=<?php echo base64_encode($list[$i]['ID']); ?>">
											 <span class="label label-success">Edit</span>
											 </a>
											
											<a href="add-training.php?deleteID=<?php echo base64_encode($list[$i]['ID']); ?>" onclick="return confirm('Are you sure you want to delete')">
