...
<!-- Mirrored from caketheme.com/html/mojuri/index8.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 12:42:28 GMT -->
<head>
		<!-- Meta Data -->
		<meta charset="UTF-8">
		<meta http-equiv="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>Home Unique | Mojuri</title>
	...
	<body class="home home-8 title-8">
		<div id="page" class="hfeed page-wrapper">
			<header id="site-header" class="site-header header-v3 small-padding">
				...
				<div class="header-desktop">
					...
					<div class="header-middle text-center bg-white no-padding">
											...
											<div class="item-content">
												...
												<div class="item-info horizontal-center vertical-middle text-center">
													<div class="content">
														...
														<a class="button-slider button button-outline border-black thick-border" href="shop-grid-left.html">SHOP NOW</a>
													</div>
												</div>
											</div>
										</div>
													...
													<div class="row">
														<div class="section-column left">
															<div class="intro-wrap">
																...
																<div class="intro-btn">
																	<a href="shop-grid-left.html" class="button button-outline border-black thick-border animation-horizontal hover-opacity">Shop Now</a>
																</div>
															</div>
														</div>
														<div class="section-column right">
															<img class="animation-horizontal" width="439" height="414" src="media/banner/intro-5.png" alt="intro">
														</div>
													</div>
												</div>
													...
													<div class="row">
														<div class="section-column left">
															<div class="intro-wrap">
																...
																<div class="intro-btn">
																	<a href="shop-grid-left.html" class="button button-outline border-black thick-border animation-horizontal hover-opacity">Learn More</a>
																</div>
															</div>
														</div>
														<div class="section-column right">
...
<!-- Mirrored from caketheme.com/html/mojuri/index8.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 12:42:31 GMT -->
</html>