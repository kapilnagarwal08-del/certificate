...
<head>
		...
		<title>Our Gallery | Indian Diamond & Gold Laboratory Of India</title>
						...
						<div id="title" class="page-title">
							<div class="section-container">
								...
								<div class="breadcrumbs">
									<a href="index.php">Home</a><span class="delimiter"></span><span class="delimiter"></span>Gallery
								</div>
							</div>
						</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/banner/ring.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/banner/ring.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Gomed</h3>
																		</div>		
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			...
																			<h3 style="background: gray;">Blue Sapphire</h3>
																		</div>		
																	...
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				...
																				<img width="600" height="600" src="media/product/5.jpg"  alt="">
																			</a>
																			<h3 style="background: gray;">Ruby</h3>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			...
																			<h3 style="background: gray;">Corel</h3>
																		</div>		
																	...
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				...
																				<img width="600" height="600" src="media/product/6.jpg" class="hover-image back" alt="">
																			</a>
																			<h3 style="background: gray;">Diamond</h3>
																		</div>		
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			...
																			<h3 style="background: gray;">Emerald</h3>
																		</div>		
																	...
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				...
																				<img width="600" height="600" src="media/product/7.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Pearl</h3>
																		</div>		
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			...
																			<h3 style="background: gray;">Yellow Sapphire</h3>
																		</div>		
															...
															<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
																	...
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				...
																				<img width="600" height="600" src="media/product/8.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Cat's Eye</h3>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/01.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/01.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Diamond Grading Report</h3>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/02.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/02.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Gem Identification Report</h3>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/03.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/03.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Jewellery Quality Analysis</h3>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/04.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/04.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Authentic Certified Gemstone</h3>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/05.jpg" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/05.jpg" alt="">
																			</a>
																			<h3 style="background: gray;">Astrology Consultancy</h3><br>
																		</div>		
																	</div>
																</div>
															</div>
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover border">
																			<a href="#">
																				<img width="600" height="600" src="media/product/rud.png" class="post-image" alt="">
																				<img width="600" height="600" src="media/product/rud.png" alt="">
																			</a>
																			<h3 style="background: gray;">Rudraksha</h3>
																		</div>		
																	</div>
																</div>
															</div>
